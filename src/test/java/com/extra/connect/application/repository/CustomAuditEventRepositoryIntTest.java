package com.extra.connect.application.repository;

import com.extra.connect.application.MyApp;
import com.extra.connect.application.config.Constants;
import com.extra.connect.application.config.audit.AuditEventConverter;
import com.extra.connect.application.domain.PersistentAuditEvent;
...
import static com.extra.connect.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
